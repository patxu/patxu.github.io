...
Going on my 5th term here, DALI has become my most cherished community at Dartmouth. As a space to learn, being able to work closely with brilliant developers has given me the chance to learn new technologies (e.g. iOS) but also taught me real-world engineering practices (e.g. source control, linting, deployment), that are often overlooked in class. In terms of leadership, I've had the opportunity to serve as as Core (student staff) member for 3 terms, leading workshops, planning events, and just helping wherever I can to help things run smoothly (I love working behind-the-scenes!). Finally, the space itself has become a relaxing and friendly place where I chat, nap, watch movies, and order late-night wings.
...
My first foray into nighttime photography, right outside my house!
{: style="color:gray; font-size: 80%; text-align: center;"}
